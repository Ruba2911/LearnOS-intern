...
export default function Sidebar() {
  return (
    <aside className="fixed left-3 top-3 z-50 hidden h-[calc(100vh-1.5rem)] w-64 flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#070817]/70 shadow-[0_24px_90px_rgba(0,0,0,0.55)] backdrop-blur-2xl lg:flex">
      ...
      <div className="pointer-events-none absolute -left-16 top-20 h-44 w-44 rounded-full bg-violet-500/15 blur-3xl" />
      {/* Logo */}
    ...
    {item.label}
      ...
      <div className="relative border-t border-white/5 p-4">
        <div className="glass-card flex items-center gap-3 rounded-2xl p-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-cyan-500 font-semibold">
            R
          </div>
